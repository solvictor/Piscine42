...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/23 21:00:49 by vegret            #+#    #+#             */
/*   Updated: 2022/07/23 21:02:38 by vegret           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	*words_lengths(char *str, char *charset)
{
	...
	i = 0;
	index = 0;
	result = (int *) malloc(nb_words(str, charset) * sizeof(int));
	if (result == NULL)
		return (NULL);
	while (str[i] != '\0')
	{
...
char	**ft_split(char *str, char *charset)
{
	...
	result = (char **) malloc(nb_words(str, charset) * sizeof(char *));
	if (result == NULL)
		return (NULL);
	i = 0;
	index = 0;
	...
	{
		result[index] = (char *) malloc((lengths[index] + 1) * sizeof(char));
